...
import static org.usfirst.frc.team2659.robot.util.motion.MotionProfileGoal.CompletionBehavior;
...
public class MotionProfileGenerator {
	 private MotionProfileGenerator() {
	    ...
	    protected static MotionProfile generateFlippedProfile(MotionProfileConstraints constraints, MotionProfileGoal goal_state, MotionState prev_state) {
	     ...
	     */
	    public synchronized static MotionProfile generateProfile(MotionProfileConstraints constraints, MotionProfileGoal goal_state, MotionState prev_state) {
	        ...
	        final double v_max = Math.min(constraints.max_abs_vel(), Math.sqrt((start_state.vel2() + goal_vel * goal_vel) / 2.0 + delta_pos * max_acc));
