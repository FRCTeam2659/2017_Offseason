...
public class SCWrapper implements SpeedController {
	private SpeedController[] speedControllerList;
	private double[] scaleFactors;

	public SCWrapper(SpeedController[] speedControllerList, double[] scaleFactors) {
	...
	public SCWrapper(SpeedController... speedControllerList) {
		this(speedControllerList, null);
	}

	public SCWrapper(SpeedController speedController) {
